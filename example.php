...
<html>
	...
	<body>
		...
		<div>
			...
			<div><strong>Run Time:</strong> <?php echo($sandbox->runTime()); ?></div>
			<div><strong>Error Log:</strong> <?php var_dump($sandbox->errors()); ?></div>
		</div>
		...
		<div>
			...
			<div><strong>Run Time:</strong> <?php echo($sandbox2->runTime()); ?></div>
			<div><strong>Error Log:</strong> <?php var_dump($sandbox2->errors()); ?></div>
		</div>
